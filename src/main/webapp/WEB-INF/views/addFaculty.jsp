              ...
              <div class="top-category pt-120 pb-90 col-12 col-md-9 col-lg-7 col-xl-6">     
                <div class="card" style="border-radius: 15px;">
                  <div class="card-body p-5">
                    <h2 class="text-uppercase text-center mb-5">Add New Faculty</h2>
      
                    <form class="form" action="registerFaculty" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <div class="d-flex justify-content-center">
                        <input type="submit" class="btn btn-block btn-success btn-large"  value="ADD FACULTY" >
                      </div>
