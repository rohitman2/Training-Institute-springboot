              ...
              <div class="top-category pt-120 pb-90 col-12 col-md-9 col-lg-7 col-xl-6">     
                <div class="card" style="border-radius: 15px;">
                  <div class="card-body p-5">
                    <h2 class="text-uppercase text-center mb-5">Delete Faculty</h2>
      
                    <form   class="form" action="delteFaculty" method="POST">

                      <div class="form-group">
                        <input type="number"  id="facultyID" name="facultyID" class="form-control form-control-lg" >
