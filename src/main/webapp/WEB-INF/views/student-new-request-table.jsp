	...
	<div class="container">
		<div class="table-wrapper">
			<div class="table-title" style="text-align: center;">
				<h2 style="color:;#f7631b">
					<b>Students New Request List</b>
				</h2>
				<br>
			</div>
		</div>
		<table class="table table-striped table-hover">
			...
			<tbody>
				<c:forEach items="${studentNewRequestsList}" var="item"
					...
					<c:if test="${item.status eq false}">
						<tr>
					     ...
					     <td><c:out
									value="${item.status == true ? 'Approved': 'Pending'}" /></td>
