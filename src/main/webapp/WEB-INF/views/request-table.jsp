							...
							<div class="row">
								<div class="col">
									<c:choose>
										<c:when test="${item.status eq 0}">
											<a
												href="../approveStudentRequest?instituteID=${sessionScope.instituteID}&userID=${item.userID}&courseID=${item.courseID}">
								...
								<div class="col">
									...
									<c:choose>
										<c:when test="${item.status eq 0}">
											<a
												href="../rejectStudentRequest?instituteID=${sessionScope.instituteID}&userID=${item.userID}&courseID=${item.courseID}">
