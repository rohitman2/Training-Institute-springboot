    ...
    <br><br>
     ...
     <div class="container">
        <section class="top-category-widget-area pt-90 pb-90 ">
            ...
            <section class="vh-100" style="background-color: #7316dd;">
                          ...
                          <div class="col-md-6 col-lg-7 d-flex align-items-center">
                            <div class="card-body p-4 p-lg-5 text-black">
                             ...
                             <div class="alert alert-danger" role="alert">
                                <h4 class="heading" style="color:crimson;">Incorrect Institute ID or Password !!! </h4>
                                </div>
                  
                                 <br>
                                 
              
                              <form class="form" action="acceptInstitute" method="POST" >
              
                                <div class="d-flex align-items-center mb-3 pb-1">

                                  <i class="fa fa-cubes fa-2x me-3" style="color: #7316dd;"></i>
                                  <span class="h1 fw-bold mb-0">Institute Login</span>
                                </div>
                                ...
                                <div class="form-outline mb-4">
                                  <input type="password" id="institutePassword" name="institutePassword" class="form-control form-control-lg" />
                                  <label class="form-label" for="institutePassword">Password</label>
                                </div>
              
                                <input type="Submit" class="btn btn-large btn-block btn-primary"  value="LOGIN INSTITUTE">
              
                                <!--<a class="small text-muted" href="#!">Forgot password?</a>-->
                                <p class="mb-5 pb-lg-2" style="color: #1e2bb9;">Don't have an account? <a href="institute-register.html" style="color: #1e2bb9;">Register here</a>
                                <p></p>
                                <p align="center">
