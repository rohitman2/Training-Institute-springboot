              ...
              <nav id="nav-menu-container">
                <ul class="nav-menu">
                  <li class="menu-has-children"><a href="">Activity</a>
                    <ul>
                      <li><a href="submitRequestForm?studentID=${STUDOBJ.userID}">Send Request</a></li>
                      <li><a href="viewresponses/${STUDOBJ.userID}">View Response</a></li>
                    </ul>
                  </li>		
                  <li><a href="submitFeedbackPage">Send Feedback</a></li>   
                  <li><a href="student-table.jsp"></a></li>
                  <li class="menu-has-children"><a href="">${STUDOBJ.userID}</a>
                    <ul>
                      <li><a href="updateStudentForm?studentID=${STUDOBJ.userID}">Edit Profile</a></li>
            ...
            <div class="container">
                <div class="row fullscreen d-flex align-items-center justify-content-between">
                    <div class="banner-content col-lg-9 col-md-12" style="margin-top: 100px;">
                        ...
                        <br><br>
                        <p class="pt-12 pb-12">
                            A student is primarily a person enrolled in a school or other educational institution and who is under learning with goals of acquiring knowledge, developing professions and achieving employment in a desired field.
                        </p>
                    </div>										
                </div>
            </div>					
