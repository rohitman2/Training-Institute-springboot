...
public class InstituteController {
	...
	private RequestDAO rdaoImpl;
	private FeedbackDAO fdaoImpl;
	...
	@Autowired
	public void setRdaoImpl(RequestDAO rdaoImpl) {
		this.rdaoImpl = rdaoImpl;
	}

	@Autowired
	public void setFdaoImpl(FeedbackDAO fdaoImpl) {
		this.fdaoImpl = fdaoImpl;
	}
	...
	public String showStudentRequests(Model m, @PathVariable int instituteID) {
		...
		List<Request> lst= 
rdaoImpl
.viewAllRequestForInstitute(instituteID);
		m.addAttribute("lst",lst);
    ...
    public String viewNewStudentRequests(Model m, @PathVariable int instituteID) {
        ...
        return "student-new-request-table"; simran
    }*/
	...
	public String viewInstFeedbacks(Model m, @PathVariable int instituteID) {
		...
		List<Feedback> lst= 
fdaoImpl.
getAllFeedbacksForInstitute(instituteID);
		m.addAttribute("lst",lst);
    ...
    public String approveStudentRequest(Model m, HttpServletRequest request) {
        ...
        if(!daoImpl.isSeatAvailable(courseID)) {
            return "seat-filled";
        }
        ...
        daoImpl.incrementFilledSeatByOne(courseID);
        daoImpl.updateStudentWithInstitute(userID,
        		instituteID);
        
        List<Request> lst= 
rdaoImpl.getAllRequests(courseID);
        m.addAttribute("lst",lst);
    ...
    public String rejectStudentRequest(Model m, HttpServletRequest request) {
        ...
        List<Request> lst= 
        		rdaoImpl.viewAllRequestForInstitute(
        				instituteID);
        m.addAttribute("lst",lst);
